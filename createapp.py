...
load_dotenv()
api = os.getenv("GROQ_API_API")

if not api:
    raise ValueError("GROQ_API_API")

retriever = retrieve()

prompt = ChatPromptTemplate.from_template("""
You are a medical assistant specialization in kidney health.
Answer the users's question in **simple, human-friendly language**.

You MUST:
- Use the context ONLY to understand the topic.
- **do NOT mention the words "context or "The context mentions".
...
st.markdown("""
    <h1 style="text-align:center;color:red;">🩺 Nephrology Q&A Assistant</h1>
